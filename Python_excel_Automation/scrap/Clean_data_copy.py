...
columns = [
    ...
    "RJ", "POA", "BH", "REC", "SP", "DF", "BEL", "FOR", "SAL", "CUR", "GOI", "NACIONAL",
    "VIT", "CG", "RB", "SL", "AJU", "Date"
]

# Set the directory where your datasets are stored
data_directory = 'C:/Users/sd74216/Desktop/Vpena/Python_excel_Automation/INPC/datas'
...
for file_name in files:
    ...
    header_row = 5 if date_code < "201509" else 4
