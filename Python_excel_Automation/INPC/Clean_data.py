...
data_directory = 'C:/Users/sd74216/Desktop/Vpena/Python_excel_Automation/INPC/datas_1'
...
for file_name in files:
    ...
    if date_code > "201101" and date_code < "20112" :
        header_row = 7
    elif date_code > "201112"  and date_code < "201412"  :
        header_row = 5
    elif date_code < "201111" :
         header_row = 4
    else :
         header_row = 4
